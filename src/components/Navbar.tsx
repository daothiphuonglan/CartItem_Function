...
export function Navbar(){
    ...
    return (
            ...
            <div className="navbar-container">
               ...
               <div className="navbar-logo"><LuPizza className="navbar-logo-icon"/>
                   <p>ANA</p>
               </div>
                  ...
                  <div className="navbar-elements">
                    <Link className="e" to="/" >Home</Link>
                    <Link className="e" to="/store">Store</Link>
                    <Link className="e" to="/about">About</Link>
                    <Link className="e" to="/blog">Blog</Link>
                  </div>
